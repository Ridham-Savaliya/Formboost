          ...
          <div className="bg-white rounded-3xl shadow-xl border border-primary/10 p-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className=" p-2 bg-primary rounded-2xl flex items-center justify-center mr-6">
...
<div className="mb-8">
  <div className="bg-white rounded-3xl shadow-xl border border-primary/10 p-2 ">
    ...
    {/* No Forms */}
    {forms.length === 0 ? (
      <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-primary-50 rounded-2xl border-2 border-dashed border-primary/30">
